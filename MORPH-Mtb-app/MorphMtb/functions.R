...
## SOM clusters
somclustersss <- function(gene_ids, somc, unit_classif){
  gene_names <- gene_ids
  # somc$cluster has one entry per SOM node; unit_classif maps each gene to its node
  # This gives each gene the cluster of its winning SOM node
